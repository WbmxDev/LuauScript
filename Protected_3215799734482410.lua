...
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/WbmxDev/MnhatYeuEm/refs/heads/main/GuiPinkNeon.lua"))()
local Window = Fluent:CreateWindow({
    Title="Wbmx Hub [ Premium ]",
    SubTitle="  by Mnhatdz", 
    TabWidth=160, 
    Theme="TuanAnhIOS",
    Acrylic=false,
...
Tabs.Main:AddButton({
        Title="Mnhatdz",
        Description="Farm Level 2650-2750 k tu dong nen tu tp qua",
        Callback=function()
    ...
    while task.wait() do
        if _G.Auto_Cake_Prince then
            pcall(function()
                ...
                -- Luôn bay tới đảo Bánh nếu ở xa
                local cakeIslandPos = CFrame.new(-2077, 252, -12373)
                if (cakeIslandPos.Position - root.Position).Magnitude > 500 then
                    _tp(cakeIslandPos)
                end

                -- Nếu Cake Prince spawn
                if bigMirror.Other.Transparency == 0 or enemies:FindFirstChild("Cake Prince") then
                    ...
                    if v then
                        ...
                        if _G.AcceptQuestC and not questUI.Visible then
                            ...
                            _tp(questPos)
                            while (questPos.Position - root.Position).Magnitude > 15 do task.wait() end
                            ...
                            local chosen = questData[math.random(1, #questData)]

                            repeat
                                game.ReplicatedStorage.Remotes.CommF_:InvokeServer(unpack(chosen))
                                task.wait(0.5)
  ...
  while task.wait() do
    if _G.Auto_Cake_Prince then
      pcall(function()
        ...
        -- Luôn đảm bảo bay tới đảo Bánh nếu đang ở xa
        local cakeIslandPos = CFrame.new(-2077, 252, -12373)
        if not bigMirror:FindFirstChild("Other") or (cakeIslandPos.Position - root.Position).Magnitude > 3000 then
          _tp(cakeIslandPos)
        end
        ...
        if bigMirror.Other.Transparency == 0 or enemies:FindFirstChild("Cake Prince") then
          ...
          if v then
            ...
            if _G.AcceptQuestC and not questUI.Visible then
              ...
              -- Thử nhận quest cho đến khi thành công
              local success = false
              repeat
