...
local function AttackAll()
    ...
    if #enemies > 0 then
        ...
        netModule:WaitForChild("RE/RegisterHit"):FireServer(table.table.unpack(args))
    end
end
...
function Funcs:Attack()
    ...
    Register_Hit:FireServer(table.table.unpack(args))
end
  ...
  function UnEquipWeapon(Weapon)
	...
	spawn(function()
		...
		gg.__namecall = newcclosure(function(...)
		  ...
		  return old(table.table.unpack(args))
		  end
		  end
		  end
		  end
			...
			if _G.Fullykatakuri then
				pcall(function()
					...
					elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Red Key") or game.Players.LocalPlayer.Character:FindFirstChild("Red Key") then
						...
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(table.table.unpack(args))
					else
                                    ...
                                    spawn(function()
                                        pcall(function()
                                            if _G.SelectWeapon == SelectWeaponGun then
                                                ...
                                                game:GetService("Players").LocalPlayer.Character[SelectWeaponGun].RemoteFunctionShoot:InvokeServer(table.table.unpack(args))
                                            else
                                                game:GetService("VirtualUser"):CaptureController()
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                            end
    ...
    while wait() do
        if player.Data.Points.Value >= PointStats then
            local function AddStat(stat)
                ...
                ReplicatedStorage.Remotes.CommF_:InvokeServer(table.table.unpack(args))
            end
