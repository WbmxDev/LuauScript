...
-- 🔍 SEARCH BAR (Pink Neon Style)
local searchFrame = Instance.new("Frame")
searchFrame.Size = UDim2.new(0, 160, 0, 28)
searchFrame.Position = UDim2.new(1, -190, 0, 7)
searchFrame.AnchorPoint = Vector2.new(1, 0)
searchFrame.BackgroundColor3 = Color3.fromRGB(35, 0, 60)
searchFrame.BackgroundTransparency = 0.2
searchFrame.BorderSizePixel = 0
searchFrame.Parent = v.TitleBar.Frame
...
searchBox.Text = ""
searchBox.TextColor3 = Color3.fromRGB(255, 180, 255)
searchBox.PlaceholderColor3 = Color3.fromRGB(150, 100, 200)
...
icon.Image = "rbxassetid://6035047409" -- icon kính lúp
icon.ImageColor3 = Color3.fromRGB(255, 170, 255)
icon.ZIndex = 1000

-- Khi người dùng nhấn Enter hoặc rời textbox
searchBox.FocusLost:Connect(function(enterPressed)
	if enterPressed then
		local text = searchBox.Text
		print("🔎 Search:", text)
		-- Thêm logic lọc tab / section ở đây
	end
end)
            local G, H =
